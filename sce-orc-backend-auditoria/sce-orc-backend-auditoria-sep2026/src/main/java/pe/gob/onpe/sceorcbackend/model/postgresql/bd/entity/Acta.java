...
public class Acta implements Serializable {
	...
	@Column(name = "n_redigital_escrutinio")
	private Short redigtalEscrutinio;

	@Column(name = "n_redigital_instalacion_sufragio")
	private Short redigtalInstalacionSufragio;

	@Column(name = "d_fecha_redigitalizacion ")
	private Date	fechaRedigitalizacion;
