...
public class ResetearTransmisionController {

	
	Logger logger = LoggerFactory.getLogger(ResetearTransmisionController.class);
	...
	public ResetearTransmisionController(
    ...
    public ResponseEntity<Boolean> tramsmitirActa(
        ...
        this.logService.registrarLog(
                usr,
                "pe.gob.onpe.sceorcbackend.rest.controller.ResetearTransmisionController.tramsmitirActa",
                        "El usuario realizo una transmision manual",
                centroc, ConstantesComunes.LOG_TRANSACCIONES_AUTORIZACION_SI, 1);
        ...
        boolean resultado = this.actaTransmisionPushService.resetear(idActa, proceso, usr);
